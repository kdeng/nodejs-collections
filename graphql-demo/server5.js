...
const queryType = new graphql.GraphQLObjectType({
  ...
  fields: {
    ...
    users: {
      ...
      resolve: function(parent, {limit, page}, {models}) {
        limit = limit || 10;
        page = page || 1;
        offset = (page-1) * limit;
        return Object.values(fakeDatabase).slice(offset, offset + limit);
      }
    },
    users1: {
      type: new graphql.GraphQLList(PersonType),
      ...
      resolve: (parent, {limit, cursor}, {models}) => {
        models.PersonType.findAll({
          limit,
          where: {
            id: {
              $gt: cursor || -1,
    ...
    users2: {
      ...
      resolve: (parent, {limit, cursor}, {models}) => {
        Object.values(fakeDatabase).findAll({
          limit,
          where: {
            id: {
              $gt: cursor || -1,
